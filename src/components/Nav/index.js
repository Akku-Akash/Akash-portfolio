            ...
            <nav className="navbar navbar-desctop">
                <div className="position-relative w-100">
                    ...
                    <div className="container d-block">
                        <a className="phone  my-0 d-none d-md-block" href={`tel: ${phone}`}>HOME</a>
                        <a className="phone  my-0 d-none d-md-block" href={`tel: ${phone}`}>ABOUT US</a>
                        <a className="phone  my-0 d-none d-md-block" href={`tel: ${phone}`}>CONTACT</a>
                        <a className="phone  my-0 d-none d-md-block" href={`tel: ${phone}`}></a>
                        <a className="phone  my-0 d-none d-md-block" href={`tel: ${phone}`}></a>
                        <a className="phone  my-0 d-none d-md-block" href={`tel: ${phone}`}></a>
                        <a className="phone  my-0 d-none d-md-block" href={`tel: ${phone}`}></a>
