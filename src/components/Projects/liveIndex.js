                    ...
                    <div className="intro">
                        <div className="scroll-wrap">
                            ...
                            <div className="container">
                                <h2 className="text-white mb-0">Live projects</h2>
                                ...
                                {/* <a target="_blank" rel="noreferrer" href="https://github.com/Akku-Akash" className="btn mt-5 mx-auto d-block" style={{ width: 'fit-content' }}>Visit my GitHub</a> */}
                            </div>
                        </div>
                    </div>
                </div>
